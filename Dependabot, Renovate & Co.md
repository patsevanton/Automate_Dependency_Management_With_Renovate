...
Мы уже говорили об этом в Developer’s Daily № 12. Это важно. Это должно регулироваться файлом журнала, но пока это работает в npm update хорошо.
...
Первый вариант, чтобы вы регулярно запускали npm update. Эта команда действительно похожа на package Jason или содержимое package.
...
Это хорошо работает, когда над кодом все равно регулярно работают. Но если долгое время никто ничего не делал с модулем, то это потому, что тесты больше не выполняются регулярно. Тогда npm update больше не будет работать регулярно.
