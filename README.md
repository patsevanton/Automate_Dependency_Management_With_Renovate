...
GITHUB_COM_TOKEN: (Опционально) Это токен нужен для получения информации о релизах и changelog (журнал изменений) в репозиториях.
...
Глава III: Расширенная настройка Renovate
...
Глава III: Обновление уязвимостей
