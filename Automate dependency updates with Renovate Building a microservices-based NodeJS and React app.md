...
Затем мы обсудим одно из возможных решений, обновлений системы. Мы настроим ее на весь проект в целом. Нам нужно добавить renovate.json.

Затем мы проверим и объединим некоторые запросы на первое вытягивание из программы Renovate.

Итак, я вернулся к своей среде разработке IDE. Мы видим, что в нашем пакете уже есть довольно много зависимостей. Это json-файл, предназначенный только для микросервиса аутентификации. Теперь это только производственные зависимости. Есть также зависимости от разработки.
