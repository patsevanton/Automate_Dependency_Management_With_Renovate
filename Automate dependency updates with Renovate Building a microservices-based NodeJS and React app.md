...
Затем мы обсудим одно из возможных решений, обновлений системы. Мы настроим ее на весь проект в целом, который будет включать в себя три этапа. Во-первых, нам нужно добавить renovate.json.

Затем мы настроим базовый бранч на обновление зависимостей. И я вернусь к этому позже, чтобы объяснить, почему я принял такое решение.
